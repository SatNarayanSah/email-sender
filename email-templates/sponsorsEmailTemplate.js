  ...
  <style type="text/css">
    ...
    * {
    ...
    @media (max-width: 480px) {
      ...
      #u_column_20 .v-col-background-color {
        background-color: #dde5f2 !important;
      }

      #u_column_21 .v-col-background-color {
        background-color: #dde5f2 !important;
      }

      #u_column_22 .v-col-background-color {
        background-color: #dde5f2 !important;
      }

      #u_column_23 .v-col-background-color {
        background-color: #dde5f2 !important;
      }

      #u_column_26 .v-col-background-color {
        background-color: #dde5f2 !important;
      }

      #u_column_27 .v-col-background-color {
        background-color: #dde5f2 !important;
      }
...
<body class="clean-body u_body"
  style="margin: 0;padding: 0;-webkit-text-size-adjust: 100%;background-color: #ecf0f1 !important;color: #000000 !important">
  <!--[if IE]><div class="ie-container"><![endif]-->
  <!--[if mso]><div class="mso-container"><![endif]-->
  <table id="u_body"
    style="border-collapse: collapse;table-layout: fixed;border-spacing: 0;mso-table-lspace: 0pt;mso-table-rspace: 0pt;vertical-align: top;min-width: 320px;Margin: 0 auto;background-color: #ecf0f1 !important;width:100%"
    ...
    <tbody>
      ...
      <table cellpadding="0" cellspacing="0" border="0" style="margin: 0 auto;min-width: 320px;max-width: 600px;">
        <tr>
          <td background="https://cdn.templates.unlayer.com/assets/1721239988259-Group%2015.png" valign="top" width="100%">
                    ...
                    <div
                        ...
                        <tbody>
                          <tr>
                            <td class="v-container-padding-padding"
                              style="overflow-wrap:break-word;word-break:break-word;padding:27px 10px 13px;font-family:'Raleway',sans-serif;"
                              align="left">

                              <!--[if mso]><table width="100%"><tr><td><![endif]-->
                              <h1 class="v-line-height v-font-size"
                                style="margin: 0px; color: #002e9f; line-height: 120%; text-align: center; word-wrap: break-word; font-family: 'Open Sans',sans-serif; font-size: 34px; font-weight: 400;">
                                    ...
                                    <div class="pt-0">
                                      <div
                                        ...
                                        <div
                                          ...
                                          <strong>Janakpur Hackathon <br /> Empowering Innovation in Madhesh</strong>
                                        </div>
                                      </div>
                                    </div>
                                  </div>
                                ...
                                <tr>
                                  <td style="padding-right: 0px;padding-left: 0px;" align="center">
                                    ...
                                    <img align="center" border="0"
                                      src="https://neelgai.vercel.app/email-images/image-1.png" alt="image"
                                      title="image"
                                      style="outline: none;text-decoration: none;-ms-interpolation-mode: bicubic;clear: both;display: inline-block !important;border: none;height: auto;float: none;width: 33%;max-width: 198px;"
                          ...
                          <tr>
                            <td class="v-container-padding-padding"
                              ...
                              <div align="center">
                                ...
                                <a href="https://neelgai.com/hackathon" target="_blank"
                                  class="v-button v-size-width v-font-size"
                                  style="box-sizing: border-box;display: inline-block;text-decoration: none;-webkit-text-size-adjust: none;text-align: center;color: #ffffff; background-color: #002e9f; border-radius: 4px;-webkit-border-radius: 4px; -moz-border-radius: 4px; width:38%; max-width:100%; overflow-wrap: break-word; word-break: break-word; word-wrap:break-word; mso-border-alt: none;font-size: 14px;">
                                  <span class="v-line-height"
                                    style="display:block;padding:10px 20px;line-height:120%;">Know More About Us</span>
                                </a>
                                <!--[if mso]></td></tr></table><![endif]-->
                              </div>
                            </td>
                        ...
                        <tbody>
                          <tr>
                            <td class="v-container-padding-padding"
                              ...
                              <!--[if mso]><table width="100%"><tr><td><![endif]-->
                              <h1 class="v-line-height v-font-size"
                                style="margin: 0px; color: #002e9f; line-height: 110%; text-align: center; word-wrap: break-word; font-family: 'Open Sans',sans-serif; font-size: 30px; font-weight: 400;">
                                <div class="flex-shrink-0 flex flex-col relative items-end">
                                  <div>
                                    <div class="pt-0">
                                      <div
                                        ...
                                        <div
                                          class="relative p-1 rounded-sm flex items-center justify-center bg-token-main-surface-primary text-token-text-primary h-8 w-8">
                                          <strong>Janakpur Hackathon: Pioneering Innovation in Madhesh</strong>
                                        </div>
                                      </div>
                                    </div>
                                  </div>
                      ...
                      <table id="u_content_text_1" style="font-family:'Raleway',sans-serif;" role="presentation"
                        ...
                        <tbody>
                          <tr>
                            <td class="v-container-padding-padding"
                              style="overflow-wrap:break-word;word-break:break-word;padding:10px 40px 20px;font-family:'Raleway',sans-serif;"
                              align="left">

                              <div class="v-line-height v-font-size"
                                style="font-size: 14px; line-height: 140%; text-align: center; word-wrap: break-word;">
                                <p style="line-height: 140%;">The Janakpur Hackathon marks a transformative moment for
                                  Madhesh, bringing together the brightest minds to foster a culture of innovation,
                                  problem-solving, and digital creativity. As the region’s first major tech event, the
                                  hackathon provides an incredible platform for developers, entrepreneurs, and tech
                                  enthusiasts to collaborate on real-world challenges and create impactful solutions for
                                  the community.</p>
                              </div>
    ...
    <![endif]-->
      ...
      <table cellpadding="0" cellspacing="0" border="0" style="margin: 0 auto;min-width: 320px;max-width: 600px;">
        <tr>
          <td background="https://cdn.templates.unlayer.com/assets/1721240673031-Group%2015c.png" valign="top" width="100%">
      <v:rect xmlns:v="urn:schemas-microsoft-com:vml" fill="true" stroke="false" style="width: 600px;">
          ...
          <div class="u-row-container"
            ...
            <div class="u-row"
              ...
              <div
                ...
                <!--[if (mso)|(IE)]><td align="center" width="300" class="v-col-background-color" style="width: 300px;padding: 0px;border-top: 0px solid transparent;border-left: 0px solid transparent;border-right: 0px solid transparent;border-bottom: 0px solid transparent;border-radius: 0px;-webkit-border-radius: 0px; -moz-border-radius: 0px;" valign="top"><![endif]-->
                <div id="u_column_22" class="u-col u-col-50"
                  style="max-width: 320px;min-width: 300px;display: table-cell;vertical-align: top;">
                  <div class="v-col-background-color"
                    style="height: 100%;width: 100% !important;border-radius: 0px;-webkit-border-radius: 0px; -moz-border-radius: 0px;">
                    <!--[if (!mso)&(!IE)]><!-->
                        ...
                        <tbody>
                          <tr>
                            <td class="v-container-padding-padding"
                              ...
                              <!--[if mso]><table width="100%"><tr><td><![endif]-->
                              <h1 class="v-line-height v-font-size"
                                style="margin: 0px; color: #002e9f; line-height: 140%; text-align: left; word-wrap: break-word; font-family: 'Open Sans',sans-serif; font-size: 22px; font-weight: 400;">
                        ...
                        <tbody>
                          <tr>
                            <td class="v-container-padding-padding"
                              ...
                              <div class="v-line-height v-font-size"
                                style="font-size: 14px; line-height: 140%; text-align: left; word-wrap: break-word;">
                                <p style="line-height: 140%;">Our goal is to establish Janakpur as a hub for
                                  technological innovation and community-driven solutions, empowering local talent and
                                  advancing Nepal's digital growth.</p>
                              </div>
                ...
                <!--[if (mso)|(IE)]></td><![endif]-->
                <!--[if (mso)|(IE)]><td align="center" width="300" class="v-col-background-color" style="width: 300px;padding: 0px;border-top: 0px solid transparent;border-left: 0px solid transparent;border-right: 0px solid transparent;border-bottom: 0px solid transparent;border-radius: 0px;-webkit-border-radius: 0px; -moz-border-radius: 0px;" valign="top"><![endif]-->
                <div id="u_column_23" class="u-col u-col-50"
                  style="max-width: 320px;min-width: 300px;display: table-cell;vertical-align: top;">
                  <div class="v-col-background-color"
                    style="height: 100%;width: 100% !important;border-radius: 0px;-webkit-border-radius: 0px; -moz-border-radius: 0px;">
                    <!--[if (!mso)&(!IE)]><!-->
                              ...
                              <table width="100%" cellpadding="0" cellspacing="0" border="0">
                                <tr>
                                  <td style="padding-right: 0px;padding-left: 0px;" align="center">
                                    ...
                                    <img align="center" border="0"
                                      src="https://neelgai.vercel.app/email-images/image-3.png" alt="image"
                                      title="image"
    ...
    <![endif]-->
      ...
      <table cellpadding="0" cellspacing="0" border="0" style="margin: 0 auto;min-width: 320px;max-width: 600px;">
        <tr>
          <td background="https://cdn.templates.unlayer.com/assets/1721240974027-Group%2015bh.png" valign="top" width="100%">
      <v:rect xmlns:v="urn:schemas-microsoft-com:vml" fill="true" stroke="false" style="width: 600px;">
        <v:fill type="frame" src="https://cdn.templates.unlayer.com/assets/1721240974027-Group%2015bh.png" /><v:textbox style="mso-fit-shape-to-text:true" inset="0,0,0,0">
      <![endif]-->

          <div class="u-row-container"
            style="padding: 0px;background-image: url('https://neelgai.vercel.app/email-images/image-10.png');background-repeat: no-repeat;background-position: center top;background-color: transparent !important">
            <div class="u-row"
              style="margin: 0 auto;min-width: 320px;max-width: 600px;overflow-wrap: break-word;word-wrap: break-word;word-break: break-word;background-color: transparent !important;">
              <div
                style="border-collapse: collapse;display: table;width: 100%;height: 100%;background-color: transparent !important;">
                <!--[if (mso)|(IE)]><table width="100%" cellpadding="0" cellspacing="0" border="0"><tr><td style="padding: 0px;background-image: url('https://neelgai.vercel.app/email-images/image-10.png');background-repeat: no-repeat;background-position: center top;background-color: transparent !important;" align="center"><table cellpadding="0" cellspacing="0" border="0" style="width:600px;"><tr style="background-color: transparent !important;"><![endif]-->
                    ...
                    <div
                      ...
                      <table style="font-family:'Raleway',sans-serif;" role="presentation" cellpadding="0"
                        ...
                        <tbody>
                          <tr>
                            <td class="v-container-padding-padding"
                              style="overflow-wrap:break-word;word-break:break-word;padding:25px 10px 0px;font-family:'Raleway',sans-serif;"
                              align="left">

                              <!--[if mso]><table width="100%"><tr><td><![endif]-->
                              <h1 class="v-line-height v-font-size"
                                style="margin: 0px; color: #002e9f; line-height: 120%; text-align: center; word-wrap: break-word; font-family: 'Open Sans',sans-serif; font-size: 22px; font-weight: 400;">
                                <span>What We Can Offer to Sponsors</span>
                              </h1>
                              <!--[if mso]></td></tr></table><![endif]-->
                      ...
                      <table id="u_content_text_3" style="font-family:'Raleway',sans-serif;" role="presentation"
                        ...
                        <tbody>
                          <tr>
                            <td class="v-container-padding-padding"
                              style="overflow-wrap:break-word;word-break:break-word;padding:10px 60px 20px;font-family:'Raleway',sans-serif;"
                              align="left">

                              <div class="v-line-height v-font-size"
                                style="font-size: 14px; line-height: 140%; text-align: center; word-wrap: break-word;">
                                <p style="line-height: 140%;">In return for your support, we are delighted to offer
                                  significant exposure to your organization within Nepal’s tech community:</p>
                                <p style="line-height: 140%;"> </p>
                                <p style="line-height: 140%;">Just follow the Bellow Link for the full info :</p>
                              </div>
            ...
            <div class="u-row-container" style="padding: 0px;background-color: transparent !important">
              <div class="u-row"
                style="margin: 0 auto;min-width: 320px;max-width: 600px;overflow-wrap: break-word;word-wrap: break-word;word-break: break-word;background-color: transparent !important;">
                <div
                  style="border-collapse: collapse;display: table;width: 100%;height: 100%;background-color: transparent !important;">
                  <!--[if (mso)|(IE)]><table width="100%" cellpadding="0" cellspacing="0" border="0"><tr><td style="padding: 0px;background-color: transparent !important;" align="center"><table cellpadding="0" cellspacing="0" border="0" style="width:600px;"><tr style="background-color: transparent !important;"><![endif]-->
                  ...
                  <div id="u_column_8" class="u-col u-col-100"
                    ...
                    <div class="v-col-background-color"
                      ...
                      <div
                        ...
                        <table id="u_content_button_4" style="font-family:'Raleway',sans-serif;" role="presentation"
                          cellpadding="0" cellspacing="0" width="100%" border="0">
                          <tbody>
                            <tr>
                              <td class="v-container-padding-padding"
                                ...
                                <div align="center">
                                  ...
                                  <a href="https://neelgai.vercel.app/email-images/Janakpur-Hackathon Sponsorship.pdf"
                                    ...
                                    <span class="v-line-height"
                                      style="display:block;padding:10px 20px;line-height:120%;">Janakpur Hackathon
                                      Sponsorship</span>
                                  </a>
                ...
                <div id="u_column_8" class="u-col u-col-100"
                  ...
                  <div class="v-col-background-color"
                    ...
                    <div
                      ...
                      <table id="u_content_image_6" style="font-family:'Raleway',sans-serif;" role="presentation"
                        cellpadding="0" cellspacing="0" width="100%" border="0">
                        <tbody>
                          <tr>
                            <td class="v-container-padding-padding"
                              ...
                              <table width="100%" cellpadding="0" cellspacing="0" border="0">
                                <tr>
                                  <td style="padding-right: 0px;padding-left: 0px;" align="center">
                                    ...
                                    <img align="center" border="0"
                                      src="https://neelgai.vercel.app/email-images/image-4.png" alt="image"
                                      title="image"
                    ...
                    <div
                      ...
                      <table id="u_content_social_1" style="font-family:'Raleway',sans-serif;" role="presentation"
                        ...
                        <tbody>
                          <tr>
                            <td class="v-container-padding-padding"
                              style="overflow-wrap:break-word;word-break:break-word;padding:25px 10px 10px;font-family:'Raleway',sans-serif;"
                              align="left">
                                    ...
                                    <tbody>
                                      <tr style="vertical-align: top">
                                        <td valign="middle"
                                          ...
                                          <a href="https://www.facebook.com/profile.php?id=61558400588347"
                                            title="Facebook" target="_blank">
                                            <img src="https://neelgai.vercel.app/email-images/image-5.png"
                                  ...
                                  <table border="0" cellspacing="0" cellpadding="0" width="32" height="32"
                                    ...
                                    <tbody>
                                      <tr style="vertical-align: top">
                                        <td valign="middle"
                                          style="word-break: break-word;border-collapse: collapse !important;vertical-align: top">
                                          <a href="https://www.linkedin.com/company/neelgai" title="LinkedIn"
                                            target="_blank">
                                            <img src="https://neelgai.vercel.app/email-images/image-6.png"
                      ...
                      <table id="u_content_text_8" style="font-family:'Raleway',sans-serif;" role="presentation"
                        cellpadding="0" cellspacing="0" width="100%" border="0">
                        <tbody>
                          <tr>
                            <td class="v-container-padding-padding"
                              style="overflow-wrap:break-word;word-break:break-word;padding:10px 100px 25px;font-family:'Raleway',sans-serif;"
                              align="left">

                              <div class="v-line-height v-font-size"
                                style="font-size: 14px; line-height: 170%; text-align: center; word-wrap: break-word;">
                                <p style="font-size: 14px; line-height: 170%;"><span
                                    style="color: #333333; font-family: Arial, sans-serif; font-size: 12.6px; text-align: center; white-space: normal; background-color: #ffffff; float: none; display: inline; line-height: 20.4px;">©
                                    Neelgai, Janakpur. All rights reserved.</span></p>
                              </div>
...
module.exports = sponsorsEmailTemplate